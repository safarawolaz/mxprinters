  ...
  return (
    <section className='w-full min-h-screen bg-orange-50  flex flex-col justify-center items-center px-4 lg:px-10 py-20'>
        <div className="flex items-center gap-2">
            ...
            <p className='text-base font-bold uppercase text-orange-700'>get in touch</p>
        </div>
        ...
        <div className="lg:flex w-full mt-10 gap-10">
            ...
            <div className="basis-1/2 w-full bg-white p-4 sm:p-10 rounded-3xl">
                <form className="flex flex-col gap-8">
                    ...
                    <Button className='bg-orange-700 py-7 text-white text-sm font-bold rounded-full tracking-wider' size='lg'>SEND MESSAGE</Button>
                </form>
            </div>
        </div>
    </section>
