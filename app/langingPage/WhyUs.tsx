...
const WhyUs = () => {
  return (
    <section className='w-full min-h-screen bg-yellow-50  flex flex-col justify-center items-center px-4 md:px-10 py-20'>
        ...
        <h3 className='text-3xl text-[#1b1b1b] sm:text-4xl font-bold mt-8'>Deliver More Than You Expect</h3>
        <p className='text-lg font-medium text-muted-foreground mt-8 text-center'>Some of the reasons to choose us</p>
        <div className="mt-10 md:flex gap-8 w-full items-center">
            <div className="basis-1/4  w-full">
                <div className="">
                    ...
                    <p className='text-base font-medium text-muted-foreground text-center md:text-right'>
