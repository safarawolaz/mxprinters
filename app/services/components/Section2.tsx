...
const Section2 = () => {
  return (
    ...
    <div className="flex items-center gap-2">
      ...
      <p className='text-base font-bold uppercase text-orange-700'>services</p>
    </div>
    ...
    <div className="mt-10 lg:flex gap-8">
            <div className="flex flex-col items-center justify-center gap-4 p-10 border border-dashed border-gray-400 rounded-3xl">
                    ...
                    <div className="text-orange-700 text-base font-bold tracking-wider uppercase">offer</div>
                    ...
                    <Link href='printing'>
                        <Button className='text-sm hover:bg-black hover:text-orange-700 text-white font-bold tracking-wider uppercase' variant='ghost' size='lg' >
                                <ArrowRight className='text-orange-700 hover:text-orange-700 w-5 h-5 mr-2' />
                                read more
                        </Button>
                    </Link>
            </div>
