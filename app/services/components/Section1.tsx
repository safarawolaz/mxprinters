...
import { FactoryIcon, UserCheckIcon, UserCircle } from 'lucide-react'
        ...
        <div className="basis-1/2 flex flex-col mt-12 md:mt-0">
            <div className="">
                <div className="flex items-center gap-2">
                    <UserCircle  className='w-5 h-5 text-[#e6413b]' />
               ...
               <div className="mt-8 flex gap-8">
                <div className="flex flex-col gap-6">
                    <FactoryIcon className='w-10 h-10 text-[#e6413b]' />
                ...
                <div className="flex flex-col gap-6">
                    <UserCheckIcon className='w-10 h-10 text-[#e6413b]' />
